package pointofsalesystemv60client;
                ...
                try
                {
                    ...
                    if(toEmailAddress.length() > 0)
                    {
                        try
                        {
                            ...
                            //emailSessionBeanRemote.emailCheckoutNotificationSync(newSaleTransactionEntity, "Tan Wee Kek<tanwk@comp.nus.edu.sg>", toEmailAddress);
                            
                            // 02 - Asynchronous Session Bean Invocation
                            //Future<Boolean> asyncResult = emailSessionBeanRemote.emailCheckoutNotificationAsync(newSaleTransactionEntity, "Tan Wee Kek<tanwk@comp.nus.edu.sg>", toEmailAddress);
